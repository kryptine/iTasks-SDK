...
//Ext.window.MessageBox.buttonText.yes = "Yes";
//Ext.window.MessageBox.buttonText.no = "No";
//Ext.window.MessageBox.buttonText.cancel = "Cancel";
//Ext.window.MessageBox.buttonText.ok = "OK";
