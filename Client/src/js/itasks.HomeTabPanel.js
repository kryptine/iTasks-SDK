	...
	initComponent: function () {
		Ext.apply(this, {
			...
			html:
				...
				'<p>Congratulations! You are now running the <span style="font-weight: bold">'+itasks.app.application+'</span>-application.</p>'+
				...
				'Clicking on an item at the top of the screen will open a tab in this window, which allows you to fulfill the selected assignment.</p>'+
				...
				'the context of several research projects on functional specifications of workflows.</p>'+
				'<p>To keep up with the latest developments, more information can be found on the Clean Wiki: <br />'+
				'<a href="http://itasks.cs.ru.nl/" target="_blank">http://itasks.cs.ru.nl/</a></p>'+
				'</div>'
