...
where
	...
	analyse [] ntests nargs nrej nund ne labels name = [blank:showName name [toString ne," errors found,": conclude ntests nargs nrej nund labels]]
	analyse _  0      nargs nrej nund 0  labels name = [blank:showName name [" Passed": conclude 0 nargs nrej nund labels]]
	analyse _  0      nargs nrej nund ne labels name = [blank:showName name [toString ne," errors found,": conclude 0 nargs nrej nund labels]]
	...
	analyse _  ntests 0     nrej nund ne labels name = [blank:showName name [toString ne," errors found,": conclude 0 0 nrej nund labels]]
			 ...
			 CE		= ["\r":showName res.name ["Counterexample ",toString (ne+1)," found after ",toString (maxTests-ntests+1)," tests:":showArgs res.args ["\n":more]]]
			 		  where
			 		  	more | ne+1<errors
			 		  		...
			 		  		= showName res.name [toString (ne+1)," errors found,": conclude (ntests-1) nargs nrej nund labels]
