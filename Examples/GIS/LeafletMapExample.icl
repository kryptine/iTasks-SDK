...
manipulateMap m = updateSharedInformation [UpdateSharedUsing id (\x y -> Just y) (const o Just) (mapEditorWrite Just (customLeafletEditor eventHandlers defaultValue))] m
