...
manipulateMap m = updateSharedInformation [UpdateSharedUsing id (flip const) (const o Just) (mapEditorWrite Just (customLeafletEditor eventHandlers defaultValue))] m
