...
manipulateMap m = updateSharedInformation [UpdateSharedUsing id (flip const) (const o Just) (customLeafletEditor {attributionControl = True, zoomControl = True, editable = True} eventHandlers defaultValue)] m
