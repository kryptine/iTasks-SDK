...
Start = test7 //(toDegrees p3,test4)
...
test7 = map pde (routeWaypoints2 entity2 (map fromDegrees INITIAL_ROUTE))
...
routeWaypoints2 me wps = steps me 0 0
...
where steps me wps t | abs me.speed < 0.1 = []
                     | otherwise          # (ne,nwps)= moveAlongWayPointsOld me wps t
...
entity2    = ne
where ne = newMovingEntity 0 (fromDegrees (INITIAL_ROUTE !! 0)) 300.0 0
