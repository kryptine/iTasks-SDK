...
calculator2 = calc2 '\0' initActionState
...
calc2 :: Char (ActionState Char CalculatorState) -> Task Int
calc2 _ st
...
view = [imageUpdate id calculatorImage (\_ _ -> Nothing) (\_ v -> v)] // to show a svg based calculator 


calculatorImage :: (ActionState Char CalculatorState) *TagSource -> Image (ActionState Char CalculatorState)
calculatorImage as _ = grid (Rows 2) (RowMajor, LeftToRight, TopToBottom) [] [] 
...
where
	...
	buttons  
		= grid (Rows 5) (RowMajor, LeftToRight, TopToBottom) [] [] 
