...
mbRegister p originalSds (Just taskId) reqSDSId iworld=:{IWorld|sdsNotifyRequests, world}
    ...
    # req = {SDSNotifyRequest|reqTimespec=ts,reqTaskId=taskId,reqSDSId=reqSDSId,cmpSDSId=originalSds,cmpParam=dynamic p,cmpParamText=toSingleLineText p, remoteOptions = Nothing}
