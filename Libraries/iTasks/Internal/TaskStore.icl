...
taskInstanceIO :: SDSLens InstanceNo (Maybe (!String,!Timestamp)) (Maybe (!String,!Timestamp))
...
allInstanceIO :: SDSLens () (Map InstanceNo (!String,!Timestamp)) (Map InstanceNo (!String,Timestamp)) 
