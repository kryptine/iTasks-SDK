...
sdsLens :: !String (p -> ps) (SDSLensRead p r rs) (SDSLensWrite p w rs ws) (SDSLensNotify p p w rs) (SDSReducer p ws w) !(sds ps rs ws) -> SDSLens p r w | gText{|*|} ps & TC ps & TC rs & TC ws & RWShared sds
