...
3. Get the latest iTasks from subversion (https://svn.cs.ru.nl/repos/iTask-system/trunk) and check it out to ~/clean/iTasks-SDK e.g. "svn co https://svn.cs.ru.nl/repos/iTask-system/trunk iTasks-SDK" from within the ~/clean directory
