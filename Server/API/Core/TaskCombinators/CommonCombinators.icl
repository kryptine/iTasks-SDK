...
assign props actionMenu task = parallel ("Assign","Manage a task assigned to another user.") (Nothing,\_ r _ -> (Just r,Just Stop), \_ (Just r) -> r) [InBodyPTask processControl] [DetachedTask props actionMenu task]
where
