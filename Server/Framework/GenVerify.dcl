...
derive gVerify Username, Password, Date, Time, FormButton, Currency, User, UserDetails, Note, DateTime, RadioChoice, ComboChoice, CheckMultiChoice, Map, Tree, TreeChoice, TreeNode, Table
derive gVerify EmailAddress, Action, HtmlDisplay, HtmlInclude, ManagementMeta, TaskPriority
