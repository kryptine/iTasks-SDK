...
derive gVerify Username, Password, Date, Time, FormButton, EUR, USD, User, UserDetails, Note, DateTime, RadioChoice, ComboChoice, GridChoice, CheckMultiChoice, Map, Tree, TreeChoice, TreeNode, Table
