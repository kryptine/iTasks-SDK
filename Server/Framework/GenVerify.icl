...
derive gVerify (,), (,,), (,,,), Void, Either, UserDetails, DateTime, Timestamp, Map, EmailAddress, Action, TreeNode, Table, Workflow, ManagerProperties, RunningTaskStatus, TaskPriority
derive bimap (,), Maybe
