...
derive gVisualizeText URL, Note, CleanCode, Username, Password, Date, Time, DateTime, Document, FormButton, EUR, USD, Scale, User, UserConstraint, RadioChoice, ComboChoice, GridChoice, CheckMultiChoice, Map, TreeChoice, Tree, TreeNode, Table, Progress
...
derive gVisualizeEditor URL, Note, CleanCode, Username, Password, Date, Time, DateTime, Document, FormButton, EUR, USD, Scale, User, UserConstraint, RadioChoice, ComboChoice, GridChoice, CheckMultiChoice, Map, TreeChoice, Tree, TreeNode, Table, Progress
...
derive gHeaders URL, Note, CleanCode, Username, Password, Date, Time, DateTime, Document, FormButton, EUR, USD, Scale, User, UserConstraint, RadioChoice, ComboChoice, GridChoice, CheckMultiChoice, Map, TreeChoice, Tree, TreeNode, Table, Progress
...
derive gGridRows URL, Note, CleanCode, Username, Password, Date, Time, DateTime, Document, FormButton, EUR, USD, Scale, User, UserConstraint, RadioChoice, ComboChoice, GridChoice, CheckMultiChoice, Map, TreeChoice, Tree, TreeNode, Table, Progress
