...
joint.shapes.tonic.TaskApp = joint.shapes.basic.Generic.extend({
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
            ...
            '.tonic-taskApp-name': { 'ref': 'rect', 'ref-x': 0.5, 'ref-y': 5, 'text-anchor': 'middle', 'font-weight': 'bold'},
...
joint.shapes.tonic.DecisionState = joint.shapes.basic.Rect.extend({
    defaults: joint.util.deepSupplement({
...
joint.shapes.tonic.LetState = joint.shapes.basic.Rect.extend({
    defaults: joint.util.deepSupplement({

        type: 'tonic.LetState',
        size: { width: 250, height: 50 },
        attrs: {
          rect: { 'width': 250, 'height': 50, 'fill': '#ffffff', 'stroke': '#000000',
