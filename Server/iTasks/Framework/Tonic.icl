...
tonicWrapTaskBody mn tn args (Task eval)
  =         return () // FIXME This is a hack to support task definitions like f = g, where g would otherwise get the same TaskId as f, overriding it in the Tonic administration
  >>~ \_ -> Task preEval
  where
