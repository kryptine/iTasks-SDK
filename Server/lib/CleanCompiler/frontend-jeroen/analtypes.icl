			...
			| gi_module<>main_dcl_module_index
				...
				= case td_rhs of
					SynType type
						...
						-> case opt_type of
							Yes type
								# icl_type_defs = { icl_type_defs & [gi_index] = { TypeDef | td & td_rhs = SynType type}}
			...
			| size new_type_defs.[gi_module]==0
					...
					SynType type
						...
						-> case opt_type of
							Yes type
								...
								# new_module_type_defs = { { type_def \\ type_def<-:com_type_defs} & [gi_index] = { TypeDef | td & td_rhs = SynType type}}
				...
				= case td_rhs of
					SynType type
						...
						-> case opt_type of
							Yes type
								# new_type_defs = {new_type_defs & [gi_module,gi_index] = { TypeDef | td & td_rhs = SynType type}}
								-> (new_type_defs, icl_type_defs, new_cons_defs, icl_cons_defs, type_heaps, dcl_modules, error)
							No
								-> (new_type_defs, icl_type_defs, new_cons_defs, icl_cons_defs, type_heaps, dcl_modules, error)
					NewType {ds_index}
...
isUnique_for_TA glob_module glob_object type_args common_defs td_infos th_vars
	...
	# (prop_classification, th_vars, td_infos)
			= propClassification glob_object glob_module (repeatn type_def.TypeDef.td_arity 0)
