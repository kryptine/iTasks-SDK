	...
	compare_type_defs copied_from_dcl dcl_type_defs dcl_cons_defs type_index (icl_type_defs, icl_cons_defs, comp_st=:{comp_type_var_heap,comp_attr_var_heap})
		| not copied_from_dcl.[type_index]
			# dcl_type_def = dcl_type_defs.[type_index]
			  ...
			  (ok, icl_cons_defs, comp_st) = compare_rhs_of_types dcl_type_def.TypeDef.td_rhs icl_type_def.TypeDef.td_rhs dcl_cons_defs icl_cons_defs comp_st
			| ok && dcl_type_def.TypeDef.td_arity==icl_type_def.TypeDef.td_arity && dcl_type_def.TypeDef.td_attribute==icl_type_def.TypeDef.td_attribute
	...
	t_corresponds dclDef iclDef
	  ...
	  where
		t_corresponds_TypeDef dclDef iclDef tc_state
			...
			= t_corresponds (dclDef.td_args, (dclDef.TypeDef.td_rhs, dclDef.td_attribute))
			 				(iclDef.td_args, (iclDef.TypeDef.td_rhs, iclDef.td_attribute)) tc_state
