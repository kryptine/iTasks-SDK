...
EndOfInput input=:{inp_stream = EmptyStream} = (True, input)
...
ReadNormalChar input=:{inp_stream = EmptyStream} = (True, NewLineChar, input)
...
ReadChar input=:{inp_stream = EmptyStream} = (True, NewLineChar, input)
