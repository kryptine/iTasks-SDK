...
simpleClickExample = updateInformation "Simple click example" [imageViewUpdate id toImage (\_ v -> v)] 25.0 
where
...
view = [imageViewUpdate id calculatorImage (\_ v -> v)] // to show a svg based calculator 
