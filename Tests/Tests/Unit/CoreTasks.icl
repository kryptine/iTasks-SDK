...
where
	...
	events = [Left ResetEvent,Right 1,Left (RefreshEvent "Update"),Right 2,Left (RefreshEvent "Update")]
	exp = [ReplaceUI initialUI, ReplaceUI initialUI, ReplaceUI finishedUI]
