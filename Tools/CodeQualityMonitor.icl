...
where
	...
	editSourceCode :: (sds () InspectState InspectState) -> Task InspectState | RWShared sds
	editSourceCode state
	...
	buildExecutable :: FilePath (sds () InspectState InspectState) -> Task () | RWShared sds
	...
	runProgram :: FilePath (sds () InspectState InspectState) -> Task () | RWShared sds
