definition module iDataHtmlDef
...
:: BodyTag			= A 				[A_Attr] [BodyTag]			// link ancor <a></a>
					...
					| Marquee			[Font_Attr] String 			// moving text <tt></tt>
					...
					| Ajax				[(String,[BodyTag])]		// a list of subpages to update via Ajax calls
...
:: Area_Attr		= Are_Alt	 		String						// Alternate text
					...
					| Are_Nohref		Bool						// Excludes an area from the image map
