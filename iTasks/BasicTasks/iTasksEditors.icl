...
where
	...
	| editor.changed
		...
		= (editor.Form.value,{tst & activated = taskdone.Form.value, html = html +|+ BT (editor.form ++ snd (pred editor.Form.value)) editor.inputs, hst = hst})
	= (editor.Form.value,{tst & activated = taskdone.Form.value, html = html +|+ BT editor.form editor.inputs, hst = hst})
